...
from transformers import GenerationConfig, LlamaForCausalLM_jump, LlamaTokenizer, LlamaConfig
...
def main(
    ...
    jump_to_layer: int = 0,  # The layer to jump to in LlamaForCausalLM_jump.
    ...
    for eval_dataset in eval_dataset_list:
        ...
        for task in task_dict.keys():
            ...
            for i in range(len(data_json_1)):
                ...
                audio_path = os.path.join(audio_data_path, cur_audio_path[1:] if cur_audio_path[0] == '/' else cur_audio_path)
