...
try:
    ...
    _import_structure["models.llama"].extend(
        ["LlamaForCausalLM", "LlamaForSequenceClassification", "LlamaModel", "LlamaPreTrainedModel", "LlamaForCausalLM_jump", "LlamaModel_jump"]
    )
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .models.llama import LlamaForCausalLM, LlamaForSequenceClassification, LlamaModel, LlamaPreTrainedModel, LlamaForCausalLM_jump, LlamaModel_jump
